...
H_TO_P: Dict[str, List[str]] = {
    ...
    # ── Yanıcı Sıvı ──────────────────────────────────────────────────────────
    'H224': ['P210','P233','P240','P241','P242','P243','P280',
             'P303+P361+P353','P370+P378','P403+P235','P501'],
    'H225': ['P210','P233','P240','P241','P242','P243','P280',
             'P303+P361+P353','P370+P378','P403+P235','P501'],
    'H226': ['P210','P233','P240','P241','P242','P243','P280','P370+P378','P403+P235','P501'],
    # H227: Yanıcı Sıvı Kat.4 (düşük tehlike) — CLP Annex IV
    'H227': ['P210','P233','P240','P280','P370+P378','P403+P235','P501'],
    ...
    'H315': ['P264','P280','P302+P352','P321','P332+P313','P362+P364','P501'],
    ...
    'H310': ['P262','P264','P270','P280','P302+P350','P310','P321','P361+P364','P405','P501'],
    ...
    'H360FD':['P201','P202','P263','P280','P308+P313','P405','P501'],
    'H361':  ['P201','P202','P263','P280','P308+P313','P405','P501'],
    'H361d': ['P201','P202','P263','P280','P308+P313','P405','P501'],
    'H361D': ['P201','P202','P263','P280','P308+P313','P405','P501'],
    'H361F': ['P201','P202','P263','P280','P308+P313','P405','P501'],
    'H361FD':['P201','P202','P263','P280','P308+P313','P405','P501'],
    'H362': ['P263','P264','P270'],

    # ── STOT ─────────────────────────────────────────────────────────────────
    'H370': ['P260','P264','P270','P307+P311','P321','P405','P501'],
    'H371': ['P260','P264','P270','P309+P311','P405','P501'],
    ...
    'H201': ['P210','P230','P234','P240','P250','P280','P370+P372+P380+P373','P401','P501'],
    'H202': ['P210','P230','P234','P240','P250','P280','P370+P372+P380+P373','P401','P501'],
    'H203': ['P210','P230','P234','P240','P250','P280','P370+P372+P380+P373','P401','P501'],
    'H204': ['P210','P234','P240','P250','P280','P370+P372+P380+P373','P401','P501'],
    'H205': ['P210','P230','P234','P240','P250','P280','P370+P380+P375','P401','P501'],

    # ── Duyarsızlaştırılmış Patlayıcılar — CLP Annex IV Tablo 2.17.2 ─────────
    ...
    'H261': ['P231+P232','P280','P302+P335+P334','P370+P378','P402+P404','P501'],

    # ── Pirofor ──────────────────────────────────────────────────────────────
    # H250: Pirofor sıvı — CLP Annex IV Tablo 6.2
    # P231+P232: inert gaz altında işlem; P233: kap sıkı kapalı
    # P302+P334: ciltle temas → soğuk su (P335+P334 katı pirofor için, sıvı için P302+P334)
    'H250': ['P210','P222','P231+P232','P233','P280','P302+P334','P370+P378','P501'],
    'H251': ['P235+P410','P407','P413','P420'],
    'H252': ['P235+P410','P407','P413','P420'],

    # ── Self-Reactive / Organik Peroksit (patlama/yangın riski) ──────────────
    # H240: Tip A — ısıtılırsa PATLAMA riski → tahliye et, müdahale ETME (P373)
    # H241: Tip B — ısıtılırsa yangın/patlama riski → uzaktan müdahale (P375)
    # H242: Tip C-F — ısıtılırsa yangın riski → normal söndürücü (P378)
    'H240': ['P210','P234','P235','P240','P280','P370+P372+P380+P373','P403','P410','P411','P420','P501'],
    'H241': ['P210','P234','P235','P240','P280','P370+P380+P375','P403','P410','P411','P420','P501'],
    'H242': ['P210','P234','P235','P240','P280','P370+P378','P403','P410','P411','P420','P501'],
...
H_BASED_LABEL_FORCED: Dict[str, List[str]] = {
    # ── Patlayıcılar — CLP Annex IV §2.1 ────────────────────────────────────
    'H200': ['P201', 'P250', 'P280'],
    'H201': ['P210', 'P230', 'P250', 'P280'],
    'H202': ['P210', 'P230', 'P250', 'P280'],
    'H203': ['P210', 'P230', 'P250', 'P280'],
    'H204': ['P210', 'P250', 'P280'],
    'H205': ['P210', 'P230', 'P250', 'P280'],
    # ── Duyarsızlaştırılmış Patlayıcılar — CLP 17. ATP ───────────────────────
    'H206': ['P210', 'P212', 'P230', 'P233', 'P280'],
    'H207': ['P210', 'P212', 'P230', 'P233', 'P280'],
    'H208': ['P210', 'P212', 'P233', 'P280'],
    ...
    'H310': ['P280', 'P302+P350', 'P310', 'P361+P364', 'P405'],
    'H311': ['P280', 'P302+P352', 'P361+P364', 'P405'],
    ...
    'H335': ['P304+P340', 'P312', 'P403+P233'],   # Solunum yolu tahrişi
    'H336': ['P304+P340', 'P312', 'P403+P233', 'P405'],   # Narkotik etki
    # ── STOT SE/RE — CLP Annex IV §3.8 ──────────────────────────────────────
    'H370': ['P307+P311', 'P321', 'P405'],
    'H371': ['P309+P311', 'P405'],
    'H372': ['P260', 'P314', 'P405'],
    'H373': ['P260', 'P314'],
    ...
    'H360FD': ['P201', 'P202', 'P263', 'P280', 'P308+P313', 'P405'],
    ...
    'H260': ['P231+P232', 'P280', 'P302+P335+P334', 'P370+P378'],
    'H261': ['P231+P232', 'P280', 'P302+P335+P334', 'P370+P378'],
