...
LANG_DATA: Dict[str, Dict] = {
    ...
    'TR': {
        ...
        'sections': {
            ...
            13: 'BÖLÜM 13: Bertaraf Hakkında Bilgiler',
        ...
        'sub': {
            ...
            '4.3': 'Derhal tıbbi müdahaleye ve özel tedaviye gerek olduğunun belirtilmesi',
            ...
            '14.7': 'IMO araçları uyarınca dökme deniz taşımacılığı',
