...
H_STMTS = {
    'TR': {
        ...
        'H260':'Su ile temas ettiğinde kendiliğinden tutuşabilen alevlenir gazlar yayar.',
        'H261':'Su ile temas ettiğinde alevlenir gazlar yayar.',
        ...
        'H350i':'İnhalasyon yoluyla kansere yol açabilir.',
        'H351':'Kansere yol açma şüphesi var.',
        'H360':'Doğmamış çocukta hasar yol açabilir veya üremeye zarar verebilir.',
        'H360D':'Doğmamış çocukta hasara yol açabilir.',
        'H360F':'Üremeye zarar verebilir.',
        'H360FD':'Doğmamış çocukta hasar yol açabilir veya üremeye zarar verebilir.',
        'H360Df':'Doğmamış çocuğa zarar verebilir. Doğurganlığa zarar verebileceğinden şüphelenilmektedir.',
        'H360Fd':'Doğurganlığa zarar verebilir. Doğmamış çocuğa zarar verebileceğinden şüphelenilmektedir.',
        'H361':'Doğmamış çocukta hasar yol açma veya üremeye zarar verme şüphesi var.',
        ...
        'H401':'Sucul ortamda toksiktir.',
        'H402':'Sucul ortamda zararlıdır.',
...
EUH_STMTS = {
    'TR': {
        ...
        'EUH201':'Kurşun içerir. Çocuklar tarafından çiğnenebilecek veya emilebilecek yüzeylerde kullanılmamalıdır.',
        ...
        'EUH209':'Kullanım esnasında çok alevlenir hale gelebilir.',
        'EUH209A':'Kullanım esnasında alevlenir hale gelebilir.',
...
P_STMTS = {
    'TR': {
        ...
        'P212':'Kapalı ortamda ısıtmaktan veya duyarsızlaştırıcı maddenin azaltılmasından kaçının.',
        ...
        'P231+P232':'Asal gaz ile elleçleyin. Nemden koruyun.',
        'P232':'Nemden koruyun.',
        ...
        'P334':'Soğuk suya daldırın/ıslak bezlerle sarın.',
        'P335+P334':'Parçacıkları cildinizden hafifçe temizleyin. Soğuk suya daldırın/ıslak bezlerle sarın.',
        'P336+P315':'Donmuş bölümleri ılık su ile eritin. Etkilenmiş alanı silmeyin.',
        'P337+P313':'Göz tahrişi kalıcı ise: Tıbbi yardım/bakım alın.',
        'P338':'Mümkün ise kontak lensleri çıkartın. Durulamaya devam edin.',
        'P340':'Zarar gören kişiyi temiz havaya çıkartın ve kolay biçimde nefes alması için rahat bir pozisyonda tutun.',
        ...
        'P361+P364':'Kirlenmiş tüm giysilerinizi hemen kaldırın/çıkartın ve yeniden kullanmadan önce yıkayın.',
        ...
        'P391':'Döküleni toplayın.',
        'P401':'....depolayın.',
        'P402':'Kuru alanda depolayınız.',
        'P402+P404':'Kuru alanda depolayınız. Kapalı bir kapta depolayın.',
        'P403':'İyi havalandırılan yerde depolayın.',
        'P403+P233':'İyi havalandırılmış bir alanda depolayınız. Kabı sıkıca kapalı tutun.',
        'P403+P235':'İyi havalandırılmış bir alanda depolayın. Soğuk tutun.',
        'P404':'Kapalı bir kapta depolayın.',
    ...
    'EN': {
        ...
        'P370+P372+P380+P373':'IN CASE OF FIRE: Risk of explosion. Evacuate area. DO NOT fight fire when fire reaches explosives.',
    ...
    'DE': {
        ...
        'P212':'Erhitzen unter Einschluss oder Verringerung des Desensibilisierungsmittels vermeiden.',
        ...
        'P370+P372+P380+P373':'BEI BRAND: Explosionsgefahr. Bereich räumen. KEIN Löschangriff, wenn Feuer Explosivstoffe erreicht.',
